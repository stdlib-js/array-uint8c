...
```javascript
import Uint8ClampedArray from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-uint8c@v0.1.0-esm/index.mjs';
```
...
import ctor from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-uint8c@v0.1.0-esm/index.mjs';
