...
```javascript
import Uint8ClampedArray from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-uint8c@v0.2.1-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/array-uint8c/actions/workflows/test.yml/badge.svg?branch=v0.2.1
[test-url]: https://github.com/stdlib-js/array-uint8c/actions/workflows/test.yml?query=branch:v0.2.1
